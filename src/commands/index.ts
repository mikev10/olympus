 ...
 * @example
 * ```typescript
 * import { expandCommand } from 'olympus';
 *
 * const prompt = expandCommand('ascent', 'Build a REST API');
 * // Returns the full ascent template with "Build a REST API" substituted
 * ```
 */
 ...
 * @example
 * ```typescript
 * import { expandCommandPrompt } from 'olympus';
