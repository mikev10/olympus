/**
 * Magic Keywords Feature - Special Trigger Detection
 *
 * Purpose: Detects special keywords in user prompts and activates enhanced behavioral modes
 *
 * Supported Keywords:
 * - ULTRAWORK/ULW: Maximum parallelization mode
 * - ULTRATHINK/THINK/DEEPTHINK: Extended reasoning mode
 * - SEARCH: Delegate to explore agent
