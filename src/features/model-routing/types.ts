 ...
 * Agent overrides are only for orchestrator-olympus (fixed to Opus).
 */
export const DEFAULT_ROUTING_CONFIG: RoutingConfig = {
  ...
  agentOverrides: {
    ...
    'orchestrator-olympus': { tier: 'HIGH', reason: 'Orchestrator requires Opus to analyze and delegate' },
  },
  escalationKeywords: [
