/**
 * Context Collector - Session Context Management
 *
 * Purpose: Manage registration and retrieval of context entries from multiple sources
 *
 * Features:
 * - Register context from various sources (files, session state, manual entries)
 * - Priority-based context ordering (critical > high > medium > low)
 * - Pending context accumulation until injection
 * - Source tracking for debugging
 *
 * Used by context-injector feature to build comprehensive session context.
 */
