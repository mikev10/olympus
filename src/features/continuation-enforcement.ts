...
/**
 * Continuation Reminder Messages
 *
 * Purpose: System reminders injected when incomplete TODOs detected
 * Trigger: On stop event when pending/in_progress tasks exist
 * Behavior: Forces automatic continuation without user confirmation
 */
const CONTINUATION_REMINDERS = [
  '[SYSTEM REMINDER - TODO CONTINUATION] Incomplete tasks remain in your todo list. Continue working on the next pending task. Proceed without asking for permission. Mark each task complete when finished. Do not stop until all tasks are done.',
  '[TODO CONTINUATION ENFORCED] Your todo list has incomplete items. The ascent does not end. Continue working on pending tasks immediately. Do not ask for permission - just execute.',
  '[OLYMPUS REMINDER] You attempted to stop with incomplete work. This is not permitted. Check your todo list and continue working on the next pending task.',
  ...
  '[THE ASCENT NEVER ENDS] Your work is not done. Resume working on incomplete tasks immediately. Verify completion before any further stop attempts.'
];
...
/**
 * System Prompt Addition - Continuation Enforcement
 *
 * Purpose: Embedded instructions for relentless task completion
 * Integration: Injected into system prompt when feature enabled
 * Behavior: Defines "The Ascent Never Ends" principle and verification checklist
 */
export const continuationSystemPromptAddition = `
## CONTINUATION ENFORCEMENT - THE ASCENT NEVER ENDS

### YOU ARE BOUND TO YOUR TODO LIST

Like the heroes who climb Mount Olympus, you are BOUND to your task list. Stopping with incomplete work is not a choice - it is a FAILURE. The system will force you back to work if you try to quit early.
...
3. **Promise Fulfilled**: You output \`<promise>DONE</promise>\` (The Ascent mode)
...
The climb ends at Olympus, or not at all."
