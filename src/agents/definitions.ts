...
export const momusAgent: AgentConfig = {
  ...
  prompt: `You are a work plan review expert. You review the provided work plan (.olympus/plans/{name}.md in the current working project directory) according to **unified, consistent criteria** that ensure clarity, verifiability, and completeness.
 ...
 */
export const orchestratorOlympusAgent: AgentConfig = {
...
/**
 * Olympus-Junior-High Agent - Complex Execution (Opus)
 */
export const olympusJuniorHighAgent: AgentConfig = {
  name: 'olympian-high',
...
/**
 * Olympus-Junior-Low Agent - Simple Execution (Haiku)
 */
export const olympusJuniorLowAgent: AgentConfig = {
  name: 'olympian-low',
...
export function getAgentDefinitions(overrides?: Partial<Record<string, Partial<AgentConfig>>>): Record<string, {
  ...
  const agents = {
    ...
    'olympian-high': olympusJuniorHighAgent,
    'olympian-low': olympusJuniorLowAgent,
