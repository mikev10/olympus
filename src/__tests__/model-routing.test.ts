...
describe('Routing Rules', () => {
  describe('evaluateRules', () => {
    ...
    it('should evaluate orchestrator rule', () => {
      const context: RoutingContext = {
        taskPrompt: 'test',
        agentType: 'orchestrator-olympus',
      };
      const signals = extractAllSignals(context.taskPrompt, context);
      const result = evaluateRules(context, signals);
...
describe('Router', () => {
  describe('routeTask', () => {
    ...
    it('should respect agent overrides', () => {
      ...
      const decision = routeTask(context, {
        agentOverrides: {
          'orchestrator-olympus': { tier: 'HIGH', reason: 'Test override' },
        },
      });
  ...
  describe('quickTierForAgent', () => {
    ...
    it('should return MEDIUM for olympian', () => {
      expect(quickTierForAgent('olympian')).toBe('MEDIUM');
    });
  ...
  describe('isFixedTierAgent', () => {
    it('should return true for orchestrator-olympus', () => {
      expect(isFixedTierAgent('orchestrator-olympus')).toBe(true);
    });
    ...
    it('should return false for olympian', () => {
      expect(isFixedTierAgent('olympian')).toBe(false);
    });
  ...
  describe('getModelForTask', () => {
    it('should return opus for orchestrator', () => {
      const result = getModelForTask('orchestrator-olympus', 'test task');
    ...
    it('should provide reasoning', () => {
      const result = getModelForTask('olympian', 'implement feature');
