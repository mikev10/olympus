...
export const MOCK_FEEDBACK_FOR_CLUSTERING: FeedbackEntry[] = [
  {
    ...
    event_type: 'revision',
    user_message: "always use TypeScript strict mode please",
  ...
  },
  {
    ...
    project_path: '/test/project',
    event_type: 'revision',
    user_message: "always use TypeScript strict mode here",
    feedback_category: 'correction',
    confidence: 0.85,
  },
  {
    ...
    project_path: '/test/project',
    event_type: 'revision',
    user_message: "always use TypeScript strict mode now",
    feedback_category: 'correction',
    confidence: 0.88,
  },
  {
  ...
  },
  {
    ...
    user_message: "always use TypeScript strict mode everywhere",
...
export const MOCK_FEEDBACK_INSUFFICIENT: FeedbackEntry[] = [
  {
    ...
    project_path: '/test/project',
    event_type: 'revision',
    user_message: "add proper error handling to this function please",
    feedback_category: 'correction',
    confidence: 0.85,
  },
  {
    ...
    project_path: '/test/project',
    event_type: 'revision',
    user_message: "add proper error handling to this method please",
    feedback_category: 'correction',
    confidence: 0.82,
  },
];
