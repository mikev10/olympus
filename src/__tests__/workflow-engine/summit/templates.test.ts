...
function createTestManifest(overrides: Partial<ManifestSchema> = {}): ManifestSchema {
  return {
    ...
    phases: {
      vision: { status: 'complete', started_at: '2024-01-01T00:00:00Z', completed_at: '2024-01-01T01:00:00Z', gate_result: null, gate_bypassed: false, bypass_reason: null },
      forge: { status: 'complete', started_at: '2024-01-01T01:00:00Z', completed_at: '2024-01-01T02:00:00Z', gate_result: null, gate_bypassed: false, bypass_reason: null },
      summit: { status: 'in_progress', started_at: '2024-01-01T02:00:00Z', completed_at: null, gate_result: null, gate_bypassed: false, bypass_reason: null },
    },
...
function createTestContext(overrides: Partial<SummitContext> = {}): SummitContext {
  return {
...
describe('Summit Templates', () => {
  describe('generateDeployGuide', () => {
    it('should generate valid deploy guide markdown', () => {
      ...
      expect(guide).toContain('phase: summit');
    ...
    it('should include artifact counts from manifest', () => {
      ...
      expect(guide).toContain('Generated from 3 artifacts (2 Vision, 1 Forge)');
    });
    ...
    it('should handle null manifest gracefully', () => {
      ...
      expect(guide).toContain('Generated from 0 artifacts (0 Vision, 0 Forge)');
    ...
    it('should include generated by footer', () => {
      ...
      expect(guide).toContain('*Generated by Summit Phase Templates*');
    });
  });
  ...
  describe('generateRunbook', () => {
    it('should generate valid runbook markdown', () => {
      ...
      expect(runbook).toContain('phase: summit');
  ...
  describe('generateMonitoringConfig', () => {
    ...
    it('should include basic metadata', () => {
      ...
      expect(config.phase).toBe('summit');
  ...
  describe('generateReleaseNotes', () => {
    it('should generate valid release notes markdown', () => {
      ...
      expect(notes).toContain('phase: summit');
    ...
    it('should include artifact counts', () => {
      ...
      expect(notes).toContain('### Vision Phase (1 artifacts)');
      expect(notes).toContain('### Forge Phase (1 artifacts)');
    });
    ...
    it('should list artifacts with details', () => {
      ...
      expect(notes).toContain('- **VIS-001** (vision/discover): active');
    });
    ...
    it('should include known issues section', () => {
      ...
      expect(notes).toContain('Summit phase is documentation-only in v1');
    });
    ...
    it('should include ODLC methodology reference', () => {
      ...
      expect(notes).toContain('ODLC (Vision → Forge → Summit)');
