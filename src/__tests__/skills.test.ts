...
describe('Builtin Skills', () => {
  ...
  describe('getBuiltinSkill()', () => {
    it('should retrieve a skill by name', () => {
      const skill = getBuiltinSkill('olympus');
      expect(skill).toBeDefined();
      expect(skill?.name).toBe('olympus');
    });

    it('should be case-insensitive', () => {
      const skillLower = getBuiltinSkill('olympus');
      const skillUpper = getBuiltinSkill('OLYMPUS');
      const skillMixed = getBuiltinSkill('OlYmPuS');
  ...
  describe('listBuiltinSkillNames()', () => {
    it('should return all skill names', () => {
      ...
      expect(names).toContain('olympus');
      expect(names).toContain('ascent');
