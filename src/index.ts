...
/**
 * Options for creating a Olympus session
 */
...
/**
 * Result of creating a Olympus session
 */
export interface OlympusSession {
 ...
 * ```
 */
export function createOlympusSession(options?: OlympusOptions): OlympusSession {
  // Load configuration
