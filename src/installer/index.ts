...
1. **Locate the Plan**: If no path provided, check \`.sisyphus/plans/\` for the most recent plan
...
Create completion record at \`.sisyphus/completions/{plan-name}-completion.md\`:
...
If COMPLETED:
1. Move plan to \`.sisyphus/archive/\`
2. Update any tracking documents
3. Report completion to user

If NOT COMPLETED:
1. Keep plan in \`.sisyphus/plans/\`
