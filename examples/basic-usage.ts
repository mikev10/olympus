 ...
 * Basic Usage Example
 *
 * This example demonstrates how to use Oh-My-Claude-Olympus
 * with the Claude Agent SDK.
 */

// Note: In real usage, import from 'oh-my-claude-olympus'
import { createOlympusSession, enhancePrompt } from '../src/index.js';

// For demonstration - in real usage, import from '@anthropic-ai/claude-agent-sdk'
// import { query } from '@anthropic-ai/claude-agent-sdk';

async function main() {
  console.log('=== Oh-My-Claude-Olympus Example ===\n');

  // Create a Olympus session
