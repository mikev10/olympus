...
| Three gates (always enforced)                                      | **Decided** | Inception exit, design approved, unit complete                                                                                                                          |
...
| One person can fill multiple roles                                 | **Decided** | Same structure, gates, artifacts regardless of team size.                                                                                                               |
...
One person can fill multiple roles. The framework behaves identically regardless of team size — same structure, same gates, same artifacts.

```
Mob = PO + BA + Tech Lead + senior devs (5-6 people)
Sarah L. (+ QA) → Unit 001, Unit 003
Alex K. (+ QA) → Unit 002
...
5. Gates are **always enforced** — one person can fill multiple reviewer roles, but approval always happens
...
| 3  | Three explicit gates                                                                | Implicit exit gates per phase                                           | Three named gates: Inception Complete, Design Approved, Unit Complete                                                                                                                                                                               | Gates are the enforcement mechanism. Making them explicit and always-on ensures quality is structural, not optional.                                                                                                                                                                                                            |
| 4  | Actor model documented                                                              | Folder structure assumed multi-team                                     | Explicit role model. Same structure, same gates. One person can fill multiple roles.                                                                                                                                                                | Framework works for any team size. One person can fill all roles. Same structure, gates, artifacts regardless.                                                                                                                                                                                                                  |
...
| 22 | One person can fill multiple roles                                                  | Unclear whether solo or team is primary                                 | One person can fill multiple roles. Same checkpoint format, same gates, same artifacts regardless of team size.                                                                                                                                     | Framework works for any team size. No special casing needed — same structure whether 1 person or 20.                                                                                                                                                                                                                           |
