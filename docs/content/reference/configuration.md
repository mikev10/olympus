...
1. **Data Capture** - Hooks estimate token usage from prompts and tool results throughout the session
...
- **[Understanding the Orchestration System](../core-concepts/orchestration)** - Detailed explanation of how token efficiency integrates with the learning system
- **[Overview](../getting-started/overview)** - High-level introduction to Olympus
- **[Installation](../getting-started/installation)** - Getting started with Olympus
