...
Use the Task tool to delegate to specialized agents. **IMPORTANT: Always use the full plugin-prefixed name** (e.g., `olympus:oracle`) to avoid duplicate agent calls and wasted tokens:

| Agent | Model | Purpose | When to Use |
|-------|-------|---------|-------------|
| `olympus:oracle` | Opus | Architecture & debugging | Complex problems, root cause analysis |
| `olympus:librarian` | Sonnet | Documentation & research | Finding docs, understanding code |
| `olympus:explore` | Haiku | Fast search | Quick file/pattern searches |
| `olympus:frontend-engineer` | Sonnet | UI/UX | Component design, styling |
| `olympus:document-writer` | Haiku | Documentation | README, API docs, comments |
| `olympus:multimodal-looker` | Sonnet | Visual analysis | Screenshots, diagrams |
| `olympus:momus` | Opus | Plan review | Critical evaluation of plans |
| `olympus:metis` | Opus | Pre-planning | Hidden requirements, risk analysis |
| `olympus:olympian` | Sonnet | Focused execution | Direct task implementation |
| `olympus:prometheus` | Opus | Strategic planning | Creating comprehensive work plans |
| `olympus:qa-tester` | Sonnet | CLI testing | Interactive CLI/service testing with tmux |

### Smart Model Routing (SAVE TOKENS)

**Choose tier based on task complexity: LOW (haiku) → MEDIUM (sonnet) → HIGH (opus)**

All agent names require the `olympus:` prefix when calling via Task tool:

| Domain | LOW (Haiku) | MEDIUM (Sonnet) | HIGH (Opus) |
|--------|-------------|-----------------|-------------|
| **Analysis** | `olympus:oracle-low` | `olympus:oracle-medium` | `olympus:oracle` |
| **Execution** | `olympus:olympian-low` | `olympus:olympian` | `olympus:olympian-high` |
| **Search** | `olympus:explore` | `olympus:explore-medium` | - |
| **Research** | `olympus:librarian-low` | `olympus:librarian` | - |
| **Frontend** | `olympus:frontend-engineer-low` | `olympus:frontend-engineer` | `olympus:frontend-engineer-high` |
| **Docs** | `olympus:document-writer` | - | - |
| **Planning** | - | - | `olympus:prometheus`, `olympus:momus`, `olympus:metis` |
