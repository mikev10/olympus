...
# Check commands/olympus.md updated
if grep -q "qa-tester" commands/olympus.md 2>/dev/null; then
    log_pass "qa-tester in commands/olympus.md"
else
    log_fail "qa-tester NOT in commands/olympus.md"
fi
