...
olympus is a Claude Code plugin that provides multi-agent orchestration capabilities.
...
- Check if user installed via correct method: `/plugin marketplace add mikev10/olympus`
